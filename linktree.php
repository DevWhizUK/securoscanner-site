...
<head>
    ...
    <title>Linktree | SecuroScanner</title>
    ...
    <div class="container mx-auto p-4 max-w-lg">
        <div class="bg-blue-100 p-6 rounded-lg shadow-lg">
            <div class="flex items-center mb-4">
                <img class="h-16 w-16 rounded-full" src="assets/img/linktree/shield.png" alt="Profile image">
                <h1 class="text-xl font-bold ml-4">SecuroScanner</h1>
            </div>
            <div>
                <a href="https://www.facebook.com/profile.php?id=61556597019147" class="flex items-center px-4 py-3 my-2 bg-gray-200 rounded-full shadow hover:bg-gray-300 transition-colors duration-300">
