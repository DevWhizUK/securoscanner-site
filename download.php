    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="mt-10">
            ...
            <div class="flex flex-row justify-center items-center space-x-4">
                ...
                <div class="bg-blue-900 text-white rounded shadow p-4 flex-1 hover:scale-105 ease-in-out duration-300">
                    ...
                    <a href="coming-soon.php" class="block">
        ...
        <div class="text-center mt-10">
            <div class="p-6 inline-block">
                ...
                <button onclick="location.href='coming-soon.php';" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Access Web App</button>
            </div>
        </div>
    </div>
    ...
    <section class="bg-blue-900 text-white py-12">
        ...
        <h3 class="text-center text-xl font-semibold mb-4">Have questions? We're here to help</h3>
            <div class="flex justify-center space-x-4">
                <button onclick="location.href='contact.php';" class="button-style bg-blue-100 text-blue-500 hover:bg-gray-100 focus:ring-blue-500 font-bold py-2 px-4 rounded border border-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2">Get In Touch</button>
                <button onclick="location.href='coming-soon.php';" class="button-style bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500 font-bold py-2 px-4 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2">Read our blog</button>
                <button onclick="location.href='coming-soon.php';" class="button-style bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500 font-bold py-2 px-4 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2">Help center</button>
                <button onclick="location.href='coming-soon.php';" class="button-style bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500 font-bold py-2 px-4 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2">Resources</button>
            </div>
        </div>
    </section>
